        ...
        with st.spinner("Mengekstrak data dari server Google..."):
            try:
                ...
                if Mode_Analisis == "Kekar Gerus Berpasangan (Conjugate Shear Joints)":
                    set1_strike, set1_dip = df['Strike_1'].dropna().
